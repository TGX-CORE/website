...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"TGX-CORE","description":"The most powerful framework to interact with the Telegram API..","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"search":{"provider":"local"},"nav":[{"text":"Documentation","link":"/documentation/README"},{"text":"Guidebook","link":"/guidebook/README"}],"sidebar":{"/documentation":[{"text":"Documentation","items":[{"text":"Introduction","link":"/documentation/README"},{"text":"classes","collapsed":true,"items":[{"text":"ActionsManager","link":"/documentation/classes\\\\ActionsManager"},{"text":"AllowedUpdatesOptions","link":"/documentation/classes\\\\AllowedUpdatesOptions"},{"text":"Auxiliary","link":"/documentation/classes\\\\Auxiliary"},{"text":"BaseChat","link":"/documentation/classes\\\\BaseChat"},{"text":"BaseGroupChat","link":"/documentation/classes\\\\BaseGroupChat"},{"text":"CallbackCollector","link":"/documentation/classes\\\\CallbackCollector"},{"text":"CallbackQuery","link":"/documentation/classes\\\\CallbackQuery"},{"text":"ChannelChat","link":"/documentation/classes\\\\ChannelChat"},{"text":"ChatAdministratorRights","link":"/documentation/classes\\\\ChatAdministratorRights"},{"text":"ChatBase","link":"/documentation/classes\\\\ChatBase"},{"text":"ChatBoost","link":"/documentation/classes\\\\ChatBoost"},{"text":"ChatInviteLinksManager","link":"/documentation/classes\\\\ChatInviteLinksManager"},{"text":"ChatJoinRequest","link":"/documentation/classes\\\\ChatJoinRequest"},{"text":"ChatMemberUpdated","link":"/documentation/classes\\\\ChatMemberUpdated"},{"text":"ChatPermissions","link":"/documentation/classes\\\\ChatPermissions"},{"text":"ChatRequestsManager","link":"/documentation/classes\\\\ChatRequestsManager"},{"text":"ChatsManager","link":"/documentation/classes\\\\ChatsManager"},{"text":"ChosenInlineResult","link":"/documentation/classes\\\\ChosenInlineResult"},{"text":"Client","link":"/documentation/classes\\\\Client"},{"text":"Collector","link":"/documentation/classes\\\\Collector"},{"text":"Command","link":"/documentation/classes\\\\Command"},{"text":"CommandsManager","link":"/documentation/classes\\\\CommandsManager"},{"text":"Event","link":"/documentation/classes\\\\Event"},{"text":"File","link":"/documentation/classes\\\\File"},{"text":"ForceReply","link":"/documentation/classes\\\\ForceReply"},{"text":"FormDataBuilder","link":"/documentation/classes\\\\FormDataBuilder"},{"text":"ForumTopic","link":"/documentation/classes\\\\ForumTopic"},{"text":"GroupChat","link":"/documentation/classes\\\\GroupChat"},{"text":"InlineKeyboardMarkup","link":"/documentation/classes\\\\InlineKeyboardMarkup"},{"text":"InlineQuery","link":"/documentation/classes\\\\InlineQuery"},{"text":"InlineQueryResults","link":"/documentation/classes\\\\InlineQueryResults"},{"text":"InputPaidMediaBuilder","link":"/documentation/classes\\\\InputPaidMediaBuilder"},{"text":"InvoicesManager","link":"/documentation/classes\\\\InvoicesManager"},{"text":"LabeledPrices","link":"/documentation/classes\\\\LabeledPrices"},{"text":"MeManager","link":"/documentation/classes\\\\MeManager"},{"text":"Member","link":"/documentation/classes\\\\Member"},{"text":"MembersManager","link":"/documentation/classes\\\\MembersManager"},{"text":"Message","link":"/documentation/classes\\\\Message"},{"text":"MessageCollector","link":"/documentation/classes\\\\MessageCollector"},{"text":"MessageEntities","link":"/documentation/classes\\\\MessageEntities"},{"text":"MessageEntitiesStore","link":"/documentation/classes\\\\MessageEntitiesStore"},{"text":"MessageReaction","link":"/documentation/classes\\\\MessageReaction"},{"text":"MessageReactionCount","link":"/documentation/classes\\\\MessageReactionCount"},{"text":"MessagesManager","link":"/documentation/classes\\\\MessagesManager"},{"text":"PaymentsManager","link":"/documentation/classes\\\\PaymentsManager"},{"text":"Poll","link":"/documentation/classes\\\\Poll"},{"text":"PollAnswer","link":"/documentation/classes\\\\PollAnswer"},{"text":"PollAnswers","link":"/documentation/classes\\\\PollAnswers"},{"text":"PollManager","link":"/documentation/classes\\\\PollManager"},{"text":"PollOptions","link":"/documentation/classes\\\\PollOptions"},{"text":"PollsManager","link":"/documentation/classes\\\\PollsManager"},{"text":"PreCheckoutQuery","link":"/documentation/classes\\\\PreCheckoutQuery"},{"text":"PrivateChat","link":"/documentation/classes\\\\PrivateChat"},{"text":"Reactions","link":"/documentation/classes\\\\Reactions"},{"text":"ReplyKeyboardMarkup","link":"/documentation/classes\\\\ReplyKeyboardMarkup"},{"text":"ReplyKeyboardRemove","link":"/documentation/classes\\\\ReplyKeyboardRemove"},{"text":"ShippingOptions","link":"/documentation/classes\\\\ShippingOptions"},{"text":"ShippingQuery","link":"/documentation/classes\\\\ShippingQuery"},{"text":"SuccessfulPayment","link":"/documentation/classes\\\\SuccessfulPayment"},{"text":"SuperGroupChat","link":"/documentation/classes\\\\SuperGroupChat"},{"text":"TopicsManager","link":"/documentation/classes\\\\TopicsManager"},{"text":"User","link":"/documentation/classes\\\\User"},{"text":"UsersManager","link":"/documentation/classes\\\\UsersManager"},{"text":"WebhookManager","link":"/documentation/classes\\\\WebhookManager"}]},{"text":"enumerations","collapsed":true,"items":[{"text":"AdministratorRight","link":"/documentation/enumerations\\\\AdministratorRight"},{"text":"AllowedUpdates","link":"/documentation/enumerations\\\\AllowedUpdates"},{"text":"Auxiliaries","link":"/documentation/enumerations\\\\Auxiliaries"},{"text":"ChatAction","link":"/documentation/enumerations\\\\ChatAction"},{"text":"ChatHold","link":"/documentation/enumerations\\\\ChatHold"},{"text":"ClientAction","link":"/documentation/enumerations\\\\ClientAction"},{"text":"ClientEvent","link":"/documentation/enumerations\\\\ClientEvent"},{"text":"CollectorEvent","link":"/documentation/enumerations\\\\CollectorEvent"},{"text":"CommandScopeType","link":"/documentation/enumerations\\\\CommandScopeType"},{"text":"Endpoint","link":"/documentation/enumerations\\\\Endpoint"},{"text":"EntityType","link":"/documentation/enumerations\\\\EntityType"},{"text":"MessagePayloadMethod","link":"/documentation/enumerations\\\\MessagePayloadMethod"},{"text":"MessageService","link":"/documentation/enumerations\\\\MessageService"},{"text":"Parseables","link":"/documentation/enumerations\\\\Parseables"},{"text":"PartialTypes","link":"/documentation/enumerations\\\\PartialTypes"},{"text":"Permission","link":"/documentation/enumerations\\\\Permission"},{"text":"Registries","link":"/documentation/enumerations\\\\Registries"}]},{"text":"interfaces","collapsed":true,"items":[{"text":"ActionsOptions","link":"/documentation/interfaces\\\\ActionsOptions"},{"text":"AdminPermissions","link":"/documentation/interfaces\\\\AdminPermissions"},{"text":"AnimationPayload","link":"/documentation/interfaces\\\\AnimationPayload"},{"text":"AudioPayload","link":"/documentation/interfaces\\\\AudioPayload"},{"text":"AuxiliaryMeta","link":"/documentation/interfaces\\\\AuxiliaryMeta"},{"text":"BackgroundFillFreeformGradient","link":"/documentation/interfaces\\\\BackgroundFillFreeformGradient"},{"text":"BackgroundFillGradient","link":"/documentation/interfaces\\\\BackgroundFillGradient"},{"text":"BackgroundFillSolid","link":"/documentation/interfaces\\\\BackgroundFillSolid"},{"text":"BackgroundTypeChatTheme","link":"/documentation/interfaces\\\\BackgroundTypeChatTheme"},{"text":"BackgroundTypeFill","link":"/documentation/interfaces\\\\BackgroundTypeFill"},{"text":"BackgroundTypePattern","link":"/documentation/interfaces\\\\BackgroundTypePattern"},{"text":"BackgroundTypeWallpaper","link":"/documentation/interfaces\\\\BackgroundTypeWallpaper"},{"text":"BaseChatInviteLinkEditPayload","link":"/documentation/interfaces\\\\BaseChatInviteLinkEditPayload"},{"text":"BaseGroupChatPacket","link":"/documentation/interfaces\\\\BaseGroupChatPacket"},{"text":"BaseMessagePayload","link":"/documentation/interfaces\\\\BaseMessagePayload"},{"text":"Birthdate","link":"/documentation/interfaces\\\\Birthdate"},{"text":"BotCommand","link":"/documentation/interfaces\\\\BotCommand"},{"text":"BusinessConnectionPacket","link":"/documentation/interfaces\\\\BusinessConnectionPacket"},{"text":"BusinessIntro","link":"/documentation/interfaces\\\\BusinessIntro"},{"text":"BusinessLocation","link":"/documentation/interfaces\\\\BusinessLocation"},{"text":"BusinessMessagesDeletedPacket","link":"/documentation/interfaces\\\\BusinessMessagesDeletedPacket"},{"text":"BusinessOpeningHours","link":"/documentation/interfaces\\\\BusinessOpeningHours"},{"text":"BusinessOpeningHoursInterval","link":"/documentation/interfaces\\\\BusinessOpeningHoursInterval"},{"text":"CallbackCollectorOptions","link":"/documentation/interfaces\\\\CallbackCollectorOptions"},{"text":"CallbackQueryPacket","link":"/documentation/interfaces\\\\CallbackQueryPacket"},{"text":"ChatActionPayload","link":"/documentation/interfaces\\\\ChatActionPayload"},{"text":"ChatBackground","link":"/documentation/interfaces\\\\ChatBackground"},{"text":"ChatBoostAdded","link":"/documentation/interfaces\\\\ChatBoostAdded"},{"text":"ChatBoostPacket","link":"/documentation/interfaces\\\\ChatBoostPacket"},{"text":"ChatBoostRemoved","link":"/documentation/interfaces\\\\ChatBoostRemoved"},{"text":"ChatBoostSourceGiftCode","link":"/documentation/interfaces\\\\ChatBoostSourceGiftCode"},{"text":"ChatBoostSourceGiveaway","link":"/documentation/interfaces\\\\ChatBoostSourceGiveaway"},{"text":"ChatBoostSourcePremium","link":"/documentation/interfaces\\\\ChatBoostSourcePremium"},{"text":"ChatBoostUpdated","link":"/documentation/interfaces\\\\ChatBoostUpdated"},{"text":"ChatInviteLink","link":"/documentation/interfaces\\\\ChatInviteLink"},{"text":"ChatInviteLinkCreatePayload","link":"/documentation/interfaces\\\\ChatInviteLinkCreatePayload"},{"text":"ChatInviteLinkSubscriptionEditPayload","link":"/documentation/interfaces\\\\ChatInviteLinkSubscriptionEditPayload"},{"text":"ChatInviteLinkSubscriptionPayload","link":"/documentation/interfaces\\\\ChatInviteLinkSubscriptionPayload"},{"text":"ChatJoinRequestPacket","link":"/documentation/interfaces\\\\ChatJoinRequestPacket"},{"text":"ChatLocation","link":"/documentation/interfaces\\\\ChatLocation"},{"text":"ChatMemberAdministrator","link":"/documentation/interfaces\\\\ChatMemberAdministrator"},{"text":"ChatMemberBanned","link":"/documentation/interfaces\\\\ChatMemberBanned"},{"text":"ChatMemberLeft","link":"/documentation/interfaces\\\\ChatMemberLeft"},{"text":"ChatMemberMember","link":"/documentation/interfaces\\\\ChatMemberMember"},{"text":"ChatMemberOwner","link":"/documentation/interfaces\\\\ChatMemberOwner"},{"text":"ChatMemberRestricted","link":"/documentation/interfaces\\\\ChatMemberRestricted"},{"text":"ChatMemberUpdatedPacket","link":"/documentation/interfaces\\\\ChatMemberUpdatedPacket"},{"text":"ChatPacket","link":"/documentation/interfaces\\\\ChatPacket"},{"text":"ChatPhoto","link":"/documentation/interfaces\\\\ChatPhoto"},{"text":"ChatShared","link":"/documentation/interfaces\\\\ChatShared"},{"text":"ChosenInlineResultPacket","link":"/documentation/interfaces\\\\ChosenInlineResultPacket"},{"text":"ClientOptions","link":"/documentation/interfaces\\\\ClientOptions"},{"text":"CollectorOptions","link":"/documentation/interfaces\\\\CollectorOptions"},{"text":"CommandMeta","link":"/documentation/interfaces\\\\CommandMeta"},{"text":"CommandScope","link":"/documentation/interfaces\\\\CommandScope"},{"text":"CommandsPayload","link":"/documentation/interfaces\\\\CommandsPayload"},{"text":"ContactPayload","link":"/documentation/interfaces\\\\ContactPayload"},{"text":"CopyMessagePayload","link":"/documentation/interfaces\\\\CopyMessagePayload"},{"text":"CreateInvoiceLinkPayload","link":"/documentation/interfaces\\\\CreateInvoiceLinkPayload"},{"text":"CustomEmoji","link":"/documentation/interfaces\\\\CustomEmoji"},{"text":"DicePayload","link":"/documentation/interfaces\\\\DicePayload"},{"text":"DocumentPayload","link":"/documentation/interfaces\\\\DocumentPayload"},{"text":"Emoji","link":"/documentation/interfaces\\\\Emoji"},{"text":"EncryptedPassportElement","link":"/documentation/interfaces\\\\EncryptedPassportElement"},{"text":"EventMeta","link":"/documentation/interfaces\\\\EventMeta"},{"text":"ExternalReplyInfo","link":"/documentation/interfaces\\\\ExternalReplyInfo"},{"text":"FilePacket","link":"/documentation/interfaces\\\\FilePacket"},{"text":"ForumTopicClosed","link":"/documentation/interfaces\\\\ForumTopicClosed"},{"text":"ForumTopicCreated","link":"/documentation/interfaces\\\\ForumTopicCreated"},{"text":"ForumTopicEdited","link":"/documentation/interfaces\\\\ForumTopicEdited"},{"text":"ForumTopicPacket","link":"/documentation/interfaces\\\\ForumTopicPacket"},{"text":"ForumTopicReopened","link":"/documentation/interfaces\\\\ForumTopicReopened"},{"text":"ForwardPayload","link":"/documentation/interfaces\\\\ForwardPayload"},{"text":"Game","link":"/documentation/interfaces\\\\Game"},{"text":"GeneralForumTopicHidden","link":"/documentation/interfaces\\\\GeneralForumTopicHidden"},{"text":"GeneralForumTopicUnhidden","link":"/documentation/interfaces\\\\GeneralForumTopicUnhidden"},{"text":"Giveaway","link":"/documentation/interfaces\\\\Giveaway"},{"text":"GiveawayCompleted","link":"/documentation/interfaces\\\\GiveawayCompleted"},{"text":"GiveawayCreated","link":"/documentation/interfaces\\\\GiveawayCreated"},{"text":"GiveawayWinners","link":"/documentation/interfaces\\\\GiveawayWinners"},{"text":"InaccessibleMessage","link":"/documentation/interfaces\\\\InaccessibleMessage"},{"text":"InlineQueryAnswer","link":"/documentation/interfaces\\\\InlineQueryAnswer"},{"text":"InlineQueryPacket","link":"/documentation/interfaces\\\\InlineQueryPacket"},{"text":"InputContactMessageContentPayload","link":"/documentation/interfaces\\\\InputContactMessageContentPayload"},{"text":"InputInvoiceMessageContentPayload","link":"/documentation/interfaces\\\\InputInvoiceMessageContentPayload"},{"text":"InputLocationMessageContentPayload","link":"/documentation/interfaces\\\\InputLocationMessageContentPayload"},{"text":"InputMediaAnimationPayload","link":"/documentation/interfaces\\\\InputMediaAnimationPayload"},{"text":"InputMediaAudioPayload","link":"/documentation/interfaces\\\\InputMediaAudioPayload"},{"text":"InputMediaDocumentPayload","link":"/documentation/interfaces\\\\InputMediaDocumentPayload"},{"text":"InputMediaPhotoPayload","link":"/documentation/interfaces\\\\InputMediaPhotoPayload"},{"text":"InputMediaVideoPayload","link":"/documentation/interfaces\\\\InputMediaVideoPayload"},{"text":"InputPaidMediaPhotoPayload","link":"/documentation/interfaces\\\\InputPaidMediaPhotoPayload"},{"text":"InputPaidMediaPreviewPayload","link":"/documentation/interfaces\\\\InputPaidMediaPreviewPayload"},{"text":"InputPaidMediaVideoPayload","link":"/documentation/interfaces\\\\InputPaidMediaVideoPayload"},{"text":"InputTextMessageContentPayload","link":"/documentation/interfaces\\\\InputTextMessageContentPayload"},{"text":"InputVenueMessageContentPayload","link":"/documentation/interfaces\\\\InputVenueMessageContentPayload"},{"text":"InvoicePacket","link":"/documentation/interfaces\\\\InvoicePacket"},{"text":"KeyboardButtonPayload","link":"/documentation/interfaces\\\\KeyboardButtonPayload"},{"text":"LabeledPrice","link":"/documentation/interfaces\\\\LabeledPrice"},{"text":"LinkPreviewOptions","link":"/documentation/interfaces\\\\LinkPreviewOptions"},{"text":"Location","link":"/documentation/interfaces\\\\Location"},{"text":"LocationPayload","link":"/documentation/interfaces\\\\LocationPayload"},{"text":"LoginUrl","link":"/documentation/interfaces\\\\LoginUrl"},{"text":"MaskPosition","link":"/documentation/interfaces\\\\MaskPosition"},{"text":"MediaGroupPayload","link":"/documentation/interfaces\\\\MediaGroupPayload"},{"text":"MessageAutoDeleteTimerChanged","link":"/documentation/interfaces\\\\MessageAutoDeleteTimerChanged"},{"text":"MessagecaptionEditPayload","link":"/documentation/interfaces\\\\MessagecaptionEditPayload"},{"text":"MessageCollectorOptions","link":"/documentation/interfaces\\\\MessageCollectorOptions"},{"text":"MessageEditPayload","link":"/documentation/interfaces\\\\MessageEditPayload"},{"text":"MessageEntityPayload","link":"/documentation/interfaces\\\\MessageEntityPayload"},{"text":"MessageMediaEditPayload","link":"/documentation/interfaces\\\\MessageMediaEditPayload"},{"text":"MessageOriginChannel","link":"/documentation/interfaces\\\\MessageOriginChannel"},{"text":"MessageOriginChat","link":"/documentation/interfaces\\\\MessageOriginChat"},{"text":"MessageOriginHiddenUser","link":"/documentation/interfaces\\\\MessageOriginHiddenUser"},{"text":"MessageOriginUser","link":"/documentation/interfaces\\\\MessageOriginUser"},{"text":"MessagePacket","link":"/documentation/interfaces\\\\MessagePacket"},{"text":"MessageReactionCountPacket","link":"/documentation/interfaces\\\\MessageReactionCountPacket"},{"text":"MessageReactionPacket","link":"/documentation/interfaces\\\\MessageReactionPacket"},{"text":"MessageReactionPayload","link":"/documentation/interfaces\\\\MessageReactionPayload"},{"text":"MessageReplyMarkupEditPayload","link":"/documentation/interfaces\\\\MessageReplyMarkupEditPayload"},{"text":"OptionalBaseMessagePayload","link":"/documentation/interfaces\\\\OptionalBaseMessagePayload"},{"text":"OrderInfo","link":"/documentation/interfaces\\\\OrderInfo"},{"text":"PaidEmoji","link":"/documentation/interfaces\\\\PaidEmoji"},{"text":"PaidMediaInfo","link":"/documentation/interfaces\\\\PaidMediaInfo"},{"text":"PaidMediaPayload","link":"/documentation/interfaces\\\\PaidMediaPayload"},{"text":"PaidMediaPurchasedPacket","link":"/documentation/interfaces\\\\PaidMediaPurchasedPacket"},{"text":"PassportData","link":"/documentation/interfaces\\\\PassportData"},{"text":"PhotoPayload","link":"/documentation/interfaces\\\\PhotoPayload"},{"text":"PhotoSize","link":"/documentation/interfaces\\\\PhotoSize"},{"text":"PollAnswerPacket","link":"/documentation/interfaces\\\\PollAnswerPacket"},{"text":"PollManagerOptions","link":"/documentation/interfaces\\\\PollManagerOptions"},{"text":"PollOption","link":"/documentation/interfaces\\\\PollOption"},{"text":"PollPacket","link":"/documentation/interfaces\\\\PollPacket"},{"text":"PollPayload","link":"/documentation/interfaces\\\\PollPayload"},{"text":"PreCheckoutQueryPacket","link":"/documentation/interfaces\\\\PreCheckoutQueryPacket"},{"text":"PrivateChatPacket","link":"/documentation/interfaces\\\\PrivateChatPacket"},{"text":"ProximityAlertTriggered","link":"/documentation/interfaces\\\\ProximityAlertTriggered"},{"text":"QueryResultArticlePayload","link":"/documentation/interfaces\\\\QueryResultArticlePayload"},{"text":"QueryResultAudioPayload","link":"/documentation/interfaces\\\\QueryResultAudioPayload"},{"text":"QueryResultButtonPayload","link":"/documentation/interfaces\\\\QueryResultButtonPayload"},{"text":"QueryResultCachedAudioPayload","link":"/documentation/interfaces\\\\QueryResultCachedAudioPayload"},{"text":"QueryResultCachedDocumentPayload","link":"/documentation/interfaces\\\\QueryResultCachedDocumentPayload"},{"text":"QueryResultCachedGifPayload","link":"/documentation/interfaces\\\\QueryResultCachedGifPayload"},{"text":"QueryResultCachedMpeg4GifPayload","link":"/documentation/interfaces\\\\QueryResultCachedMpeg4GifPayload"},{"text":"QueryResultCachedPhotoPayload","link":"/documentation/interfaces\\\\QueryResultCachedPhotoPayload"},{"text":"QueryResultCachedStickerPayload","link":"/documentation/interfaces\\\\QueryResultCachedStickerPayload"},{"text":"QueryResultCachedVideoPayload","link":"/documentation/interfaces\\\\QueryResultCachedVideoPayload"},{"text":"QueryResultCachedVoicePayload","link":"/documentation/interfaces\\\\QueryResultCachedVoicePayload"},{"text":"QueryResultContactPayload","link":"/documentation/interfaces\\\\QueryResultContactPayload"},{"text":"QueryResultDocumentPayload","link":"/documentation/interfaces\\\\QueryResultDocumentPayload"},{"text":"QueryResultGamePayload","link":"/documentation/interfaces\\\\QueryResultGamePayload"},{"text":"QueryResultGifPayload","link":"/documentation/interfaces\\\\QueryResultGifPayload"},{"text":"QueryResultLocationPayload","link":"/documentation/interfaces\\\\QueryResultLocationPayload"},{"text":"QueryResultMpeg4GifPayload","link":"/documentation/interfaces\\\\QueryResultMpeg4GifPayload"},{"text":"QueryResultPhotoPayload","link":"/documentation/interfaces\\\\QueryResultPhotoPayload"},{"text":"QueryResultVenuePayload","link":"/documentation/interfaces\\\\QueryResultVenuePayload"},{"text":"QueryResultVideoPayload","link":"/documentation/interfaces\\\\QueryResultVideoPayload"},{"text":"QueryResultVoicePayload","link":"/documentation/interfaces\\\\QueryResultVoicePayload"},{"text":"ReactionTypeCustomEmoji","link":"/documentation/interfaces\\\\ReactionTypeCustomEmoji"},{"text":"ReactionTypeEmoji","link":"/documentation/interfaces\\\\ReactionTypeEmoji"},{"text":"ReactionTypePaid","link":"/documentation/interfaces\\\\ReactionTypePaid"},{"text":"RefundedPayment","link":"/documentation/interfaces\\\\RefundedPayment"},{"text":"ReplyButtonPayload","link":"/documentation/interfaces\\\\ReplyButtonPayload"},{"text":"ReplyParameters","link":"/documentation/interfaces\\\\ReplyParameters"},{"text":"RequestChat","link":"/documentation/interfaces\\\\RequestChat"},{"text":"RequestUsers","link":"/documentation/interfaces\\\\RequestUsers"},{"text":"SendInvoicePayload","link":"/documentation/interfaces\\\\SendInvoicePayload"},{"text":"SharedUser","link":"/documentation/interfaces\\\\SharedUser"},{"text":"ShippingAddress","link":"/documentation/interfaces\\\\ShippingAddress"},{"text":"ShippingOptionPayload","link":"/documentation/interfaces\\\\ShippingOptionPayload"},{"text":"ShippingQueryPacket","link":"/documentation/interfaces\\\\ShippingQueryPacket"},{"text":"Sticker","link":"/documentation/interfaces\\\\Sticker"},{"text":"StoredInvoice","link":"/documentation/interfaces\\\\StoredInvoice"},{"text":"Story","link":"/documentation/interfaces\\\\Story"},{"text":"SuccessfulPaymentPacket","link":"/documentation/interfaces\\\\SuccessfulPaymentPacket"},{"text":"SwitchInlineQueryChosenChat","link":"/documentation/interfaces\\\\SwitchInlineQueryChosenChat"},{"text":"TextPayload","link":"/documentation/interfaces\\\\TextPayload"},{"text":"TextQuote","link":"/documentation/interfaces\\\\TextQuote"},{"text":"UpdatePacket","link":"/documentation/interfaces\\\\UpdatePacket"},{"text":"UserPacket","link":"/documentation/interfaces\\\\UserPacket"},{"text":"UserProfilePhotos","link":"/documentation/interfaces\\\\UserProfilePhotos"},{"text":"UsersShared","link":"/documentation/interfaces\\\\UsersShared"},{"text":"VenuePayload","link":"/documentation/interfaces\\\\VenuePayload"},{"text":"Video","link":"/documentation/interfaces\\\\Video"},{"text":"VideoChatEnded","link":"/documentation/interfaces\\\\VideoChatEnded"},{"text":"VideoChatParticipantsInvited","link":"/documentation/interfaces\\\\VideoChatParticipantsInvited"},{"text":"VideoChatScheduled","link":"/documentation/interfaces\\\\VideoChatScheduled"},{"text":"VideoChatStarted","link":"/documentation/interfaces\\\\VideoChatStarted"},{"text":"VideoNotePayload","link":"/documentation/interfaces\\\\VideoNotePayload"},{"text":"Voice","link":"/documentation/interfaces\\\\Voice"},{"text":"VoicePayload","link":"/documentation/interfaces\\\\VoicePayload"},{"text":"WebAppData","link":"/documentation/interfaces\\\\WebAppData"},{"text":"WebAppInfo","link":"/documentation/interfaces\\\\WebAppInfo"},{"text":"WebhookInfo","link":"/documentation/interfaces\\\\WebhookInfo"},{"text":"WebhookManagerOptions","link":"/documentation/interfaces\\\\WebhookManagerOptions"},{"text":"WriteAccessAllowed","link":"/documentation/interfaces\\\\WriteAccessAllowed"}]},{"text":"namespaces","collapsed":true,"items":[{"text":"Emoji","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\Emoji\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Custom","link":"/documentation/namespaces\\\\Emoji\\\\functions\\\\Custom"},{"text":"Emoji","link":"/documentation/namespaces\\\\Emoji\\\\functions\\\\Emoji"},{"text":"Paid","link":"/documentation/namespaces\\\\Emoji\\\\functions\\\\Paid"}]}]},{"text":"InlineQueryResultButton","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\InlineQueryResultButton\\\\README"},{"text":"classes","collapsed":true,"items":[{"text":"Start","link":"/documentation/namespaces\\\\InlineQueryResultButton\\\\classes\\\\Start"},{"text":"WebApp","link":"/documentation/namespaces\\\\InlineQueryResultButton\\\\classes\\\\WebApp"}]}]},{"text":"InputMessage","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\InputMessage\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Contact","link":"/documentation/namespaces\\\\InputMessage\\\\functions\\\\Contact"},{"text":"Invoice","link":"/documentation/namespaces\\\\InputMessage\\\\functions\\\\Invoice"},{"text":"Location","link":"/documentation/namespaces\\\\InputMessage\\\\functions\\\\Location"},{"text":"Text","link":"/documentation/namespaces\\\\InputMessage\\\\functions\\\\Text"},{"text":"Venue","link":"/documentation/namespaces\\\\InputMessage\\\\functions\\\\Venue"}]}]},{"text":"KeyboardButton","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\KeyboardButton\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"CallbackData","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\CallbackData"},{"text":"CallbackGame","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\CallbackGame"},{"text":"LoginUrl","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\LoginUrl"},{"text":"Pay","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\Pay"},{"text":"SwitchInlineQuery","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\SwitchInlineQuery"},{"text":"SwitchInlineQueryChosenChat","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\SwitchInlineQueryChosenChat"},{"text":"SwitchInlineQueryCurrentChat","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\SwitchInlineQueryCurrentChat"},{"text":"Text","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\Text"},{"text":"Url","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\Url"},{"text":"WebAppInfo","link":"/documentation/namespaces\\\\KeyboardButton\\\\functions\\\\WebAppInfo"}]}]},{"text":"Media","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\Media\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Animation","link":"/documentation/namespaces\\\\Media\\\\functions\\\\Animation"},{"text":"Audio","link":"/documentation/namespaces\\\\Media\\\\functions\\\\Audio"},{"text":"Document","link":"/documentation/namespaces\\\\Media\\\\functions\\\\Document"},{"text":"Photo","link":"/documentation/namespaces\\\\Media\\\\functions\\\\Photo"},{"text":"Video","link":"/documentation/namespaces\\\\Media\\\\functions\\\\Video"}]}]},{"text":"MenuButton","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\MenuButton\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Commands","link":"/documentation/namespaces\\\\MenuButton\\\\functions\\\\Commands"},{"text":"Default","link":"/documentation/namespaces\\\\MenuButton\\\\functions\\\\Default"},{"text":"WebApp","link":"/documentation/namespaces\\\\MenuButton\\\\functions\\\\WebApp"}]}]},{"text":"MessageEntity","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\MessageEntity\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Blockquote","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Blockquote"},{"text":"Bold","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Bold"},{"text":"BotCommand","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\BotCommand"},{"text":"Cashtag","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Cashtag"},{"text":"Code","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Code"},{"text":"CustomEmoji","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\CustomEmoji"},{"text":"Email","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Email"},{"text":"ExpandableBlockquote","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\ExpandableBlockquote"},{"text":"Hashtag","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Hashtag"},{"text":"Italic","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Italic"},{"text":"Mention","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Mention"},{"text":"PhoneNumber","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\PhoneNumber"},{"text":"Pre","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Pre"},{"text":"Spoiler","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Spoiler"},{"text":"Strikethrough","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Strikethrough"},{"text":"TextLink","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\TextLink"},{"text":"TextMention","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\TextMention"},{"text":"Underline","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Underline"},{"text":"Url","link":"/documentation/namespaces\\\\MessageEntity\\\\functions\\\\Url"}]}]},{"text":"PaidMedia","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\PaidMedia\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Photo","link":"/documentation/namespaces\\\\PaidMedia\\\\functions\\\\Photo"},{"text":"Video","link":"/documentation/namespaces\\\\PaidMedia\\\\functions\\\\Video"}]}]},{"text":"QueryResult","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\QueryResult\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Article","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Article"},{"text":"Audio","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Audio"},{"text":"Button","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Button"},{"text":"CachedAudio","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedAudio"},{"text":"CachedDocument","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedDocument"},{"text":"CachedGif","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedGif"},{"text":"CachedMpeg4Gif","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedMpeg4Gif"},{"text":"CachedPhoto","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedPhoto"},{"text":"CachedSticker","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedSticker"},{"text":"CachedVideo","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedVideo"},{"text":"CachedVoice","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\CachedVoice"},{"text":"Contact","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Contact"},{"text":"Document","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Document"},{"text":"Game","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Game"},{"text":"Gif","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Gif"},{"text":"Location","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Location"},{"text":"Mpeg4Gif","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Mpeg4Gif"},{"text":"Photo","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Photo"},{"text":"Venue","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Venue"},{"text":"Video","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Video"},{"text":"Voice","link":"/documentation/namespaces\\\\QueryResult\\\\functions\\\\Voice"}]}]},{"text":"ReplyButton","collapsed":true,"items":[{"text":"Introduction","link":"/documentation/namespaces\\\\ReplyButton\\\\README"},{"text":"functions","collapsed":true,"items":[{"text":"Chats","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\Chats"},{"text":"Contact","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\Contact"},{"text":"Location","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\Location"},{"text":"Poll","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\Poll"},{"text":"Text","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\Text"},{"text":"Users","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\Users"},{"text":"WebApp","link":"/documentation/namespaces\\\\ReplyButton\\\\functions\\\\WebApp"}]}]}]},{"text":"type-aliases","collapsed":true,"items":[{"text":"AcceptedEmoji","link":"/documentation/type-aliases\\\\AcceptedEmoji"},{"text":"BackgroundFill","link":"/documentation/type-aliases\\\\BackgroundFill"},{"text":"BackgroundType","link":"/documentation/type-aliases\\\\BackgroundType"},{"text":"Chat","link":"/documentation/type-aliases\\\\Chat"},{"text":"ChatBoostSource","link":"/documentation/type-aliases\\\\ChatBoostSource"},{"text":"ChatMember","link":"/documentation/type-aliases\\\\ChatMember"},{"text":"ChatMemberPacket","link":"/documentation/type-aliases\\\\ChatMemberPacket"},{"text":"ChatMemberStatus","link":"/documentation/type-aliases\\\\ChatMemberStatus"},{"text":"ChatMenuButton","link":"/documentation/type-aliases\\\\ChatMenuButton"},{"text":"CollectorFilter","link":"/documentation/type-aliases\\\\CollectorFilter"},{"text":"Emojis","link":"/documentation/type-aliases\\\\Emojis"},{"text":"FormAppendData","link":"/documentation/type-aliases\\\\FormAppendData"},{"text":"InlineKeyboardButton","link":"/documentation/type-aliases\\\\InlineKeyboardButton"},{"text":"InlineQueryResult","link":"/documentation/type-aliases\\\\InlineQueryResult"},{"text":"InlineQueryResultButtonType","link":"/documentation/type-aliases\\\\InlineQueryResultButtonType"},{"text":"InputFile","link":"/documentation/type-aliases\\\\InputFile"},{"text":"InputMedia","link":"/documentation/type-aliases\\\\InputMedia"},{"text":"InputMessageContent","link":"/documentation/type-aliases\\\\InputMessageContent"},{"text":"InputPaidMedia","link":"/documentation/type-aliases\\\\InputPaidMedia"},{"text":"MessageEntitiesType","link":"/documentation/type-aliases\\\\MessageEntitiesType"},{"text":"MessageOrigin","link":"/documentation/type-aliases\\\\MessageOrigin"},{"text":"MessagePayload","link":"/documentation/type-aliases\\\\MessagePayload"},{"text":"ReactionType","link":"/documentation/type-aliases\\\\ReactionType"},{"text":"ReplyKeyboardButton","link":"/documentation/type-aliases\\\\ReplyKeyboardButton"}]}]}],"/guidebook":[{"text":"Guidebook","items":[{"text":"Introduction","link":"/guidebook/README"},{"text":"Commands","collapsed":true,"items":[{"text":"Introduction","link":"/guidebook/Commands\\\\README"},{"text":"Registry Setup","link":"/guidebook/Commands\\\\Registry Setup"}]},{"text":"Payments","collapsed":true,"items":[{"text":"Introduction","link":"/guidebook/Payments\\\\README"},{"text":"PreCheckout","link":"/guidebook/Payments\\\\PreCheckout"},{"text":"Refund","link":"/guidebook/Payments\\\\Refund"},{"text":"Sending Invoice","link":"/guidebook/Payments\\\\Sending Invoice"},{"text":"Shipping","link":"/guidebook/Payments\\\\Shipping"},{"text":"Succesful Payment","link":"/guidebook/Payments\\\\Succesful Payment"}]},{"text":"Registries","collapsed":true,"items":[{"text":"Introduction","link":"/guidebook/Registries\\\\README"},{"text":"Auxiliaries","link":"/guidebook/Registries\\\\Auxiliaries"},{"text":"Commands","link":"/guidebook/Registries\\\\Commands"},{"text":"Events","link":"/guidebook/Registries\\\\Events"}]},{"text":"Updates","collapsed":true,"items":[{"text":"Methods","link":"/guidebook/Updates\\\\Methods"}]},{"text":"Working With Files","collapsed":true,"items":[{"text":"Sending a file","link":"/guidebook/Working With Files\\\\Sending a file"}]}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/vuejs/vitepress"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-17a5e62e"]]);
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BdDLYIlK.js"));
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-7f31e1f6"]]);
const _sfc_main$l = /* @__PURE__ */ defineComponent({
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-b7550ba0"]]);
const _sfc_main$c = /* @__PURE__ */ defineComponent({
